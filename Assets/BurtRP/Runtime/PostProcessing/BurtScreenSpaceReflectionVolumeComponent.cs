...
namespace Burt.RenderPipeline
{
    ...
    public enum BurtScreenSpaceReflectionResolution
    {
        Full = 0,
        Half = 1
    }
    ...
    [Serializable]
    public sealed class BurtScreenSpaceReflectionResolutionParameter : VolumeParameter<BurtScreenSpaceReflectionResolution>, IEquatable<BurtScreenSpaceReflectionResolutionParameter>
    {
        public BurtScreenSpaceReflectionResolutionParameter(BurtScreenSpaceReflectionResolution value, bool overrideState = false)
            : base(value, overrideState)
        {
        }

        public static bool operator ==(BurtScreenSpaceReflectionResolutionParameter lhs, BurtScreenSpaceReflectionResolution rhs)
        {
            return lhs != null && lhs.value == rhs;
        }
        ...
        public bool Equals(BurtScreenSpaceReflectionResolutionParameter other)
        {
            return other != null && value == other.value && overrideState == other.overrideState;
        }
        ...
        public override bool Equals(object obj)
        {
            return Equals(obj as BurtScreenSpaceReflectionResolutionParameter);
        }
    }
    ...
    public sealed class BurtScreenSpaceReflectionVolumeComponent : VolumeComponent
    {
        ...
        public BurtScreenSpaceReflectionQualityParameter quality = new BurtScreenSpaceReflectionQualityParameter(BurtScreenSpaceReflectionQuality.Medium);
        [InfoBox("Used by Custom. Low and Medium force Half for performance; High forces Full for quality.")]
        public BurtScreenSpaceReflectionResolutionParameter resolution = new BurtScreenSpaceReflectionResolutionParameter(BurtScreenSpaceReflectionResolution.Half);
