Shader "Hidden/BurtRP/DeferredPunctualTileLighting"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        HLSLINCLUDE
            // Dedicated tile/bin punctual shader. The tile vertex path is
            // static, and only the two unshadowed loop specializations add
            // fragment variants. Shadow tiles use the default keyword variant.
            #define BURT_PUNCTUAL_TILE_DRAW 1
            #pragma shader_feature_local_fragment _ BURT_USE_DEBUG_MODE_DEFERRED
            #pragma multi_compile_local_fragment _ BURT_PUNCTUAL_BIN_1_2 BURT_PUNCTUAL_BIN_3_8
