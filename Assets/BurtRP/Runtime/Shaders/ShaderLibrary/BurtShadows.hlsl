...
// 声明主光 shadow map 比较采样纹理，它由 BurtRP 的主光阴影 pass 上传。
...
{
    // 乘以 C# 上传的矩阵，让所有 shader pass 使用同一套阴影投影。
    return mul(_BurtMainLightWorldToShadow, positionWS);
}
