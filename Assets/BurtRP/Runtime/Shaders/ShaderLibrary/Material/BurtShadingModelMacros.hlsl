...
#if !defined(BURT_MATERIAL_SHADING_MODEL_DEFAULT_LIT) && !defined(BURT_MATERIAL_SHADING_MODEL_HAIR) && !defined(BURT_MATERIAL_SHADING_MODEL_CLEAR_COAT) && !defined(BURT_MATERIAL_SHADING_MODEL_SUBSURFACE) && !defined(BURT_MATERIAL_SHADING_MODEL_FABRIC) && !defined(BURT_MATERIAL_SHADING_MODEL_SILK) && !defined(BURT_MATERIAL_SHADING_MODEL_FOLIAGE)
