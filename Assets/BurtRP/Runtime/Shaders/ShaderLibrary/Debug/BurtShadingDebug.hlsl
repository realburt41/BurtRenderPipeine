...
#if (defined(BURT_SHADING_DEBUG) || defined(BURT_FORWARD_SHADING_DEBUG_LIGHTING) || defined(BURT_FORWARD_SHADING_DEBUG_BRDF) || defined(BURT_FORWARD_SHADING_DEBUG_SHADOW) || defined(BURT_FORWARD_SHADING_DEBUG_TRANSMISSION)) && !defined(BURT_ENABLE_SHADING_DEBUG)
